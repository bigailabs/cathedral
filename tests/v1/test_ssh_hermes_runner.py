...
# Direct-module-load dance — avoids the cathedral.eval.__init__ ->
# publisher import cycle. SshHermesRunner depends only on the base
# runner types, so pre-load runner_types (not the card-runner module)
# into sys.modules before loading ssh_hermes_runner by file path.
