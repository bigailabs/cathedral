...
const CACHE_POLICIES = new Map([
  ...
  ["/v1/validator/weights/next", { freshTtl: 15, edgeTtl: 1200, swr: true, params: [] }],
  ["/v1/leaderboard/recent", { freshTtl: 2, edgeTtl: 20, swr: true, params: ["limit", "since", "since_ran_at", "since_id"] }],
