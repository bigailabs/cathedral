...
CORE_REQUIRED = {
    ...
    "CATHEDRAL_V2_VERIFY_BATCH_SIZE": "async verifier batch size; use <=32 for relaunch",
...
SUPPORTING_OPTIONAL = {
    ...
    # Retention floors. The preflight retention consistency check REQUIRES
    # these to be >= CATHEDRAL_WEIGHTS_WINDOW_HOURS once the weights window is
    # widened past the 48h defaults (done 2026-07-10 for reopen coverage), so
    # they are part of the launch surface, not legacy noise.
    "CATHEDRAL_RETENTION_SOLVE_LEDGER_HOURS",
    "CATHEDRAL_RETENTION_EVAL_RUNS_HOURS",
    "CATHEDRAL_RETENTION_PM_ATTEMPT_HOURS",
...
LAUNCH_INT_CEILINGS = {
    ...
    "CATHEDRAL_V2_VERIFY_BATCH_SIZE": (1, 32),
