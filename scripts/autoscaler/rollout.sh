...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo ""
            echo "Rollout basilica-autoscaler deployment in K3s cluster"
            echo ""
            echo "Options:"
            echo "  --namespace NAMESPACE     Kubernetes namespace (default: basilica-system)"
            echo "  --deployment DEPLOYMENT   Deployment name (default: basilica-autoscaler)"
            ...
            echo "  $0"
            echo "  $0 --follow-logs"
            echo "  $0 --namespace basilica-system --deployment basilica-autoscaler"
            exit 0
            ;;
        *)
...
echo "Rolling out autoscaler deployment..."
