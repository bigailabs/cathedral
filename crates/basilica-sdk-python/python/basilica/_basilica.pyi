...
class StartRentalApiRequest:
    ...
    @property
    def max_hourly_rate(self) -> typing.Optional[builtins.float]: ...
    @property
    ...
    def max_hourly_rate(self, value: typing.Optional[builtins.float]) -> None: ...
    @container_image.setter
